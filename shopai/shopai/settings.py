...
SECRET_KEY = 'django-insecure-shopai-secret-key-change-in-production-2024xyz'
DEBUG = True
ALLOWED_HOSTS = ['*']
...
DEFAULT_FROM_EMAIL = 'ShopAI <noreply@shopai.com>'

# Payment Keys (replace with real keys)
